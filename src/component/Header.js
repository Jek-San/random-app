                        ...
                        <NavLink
                          ...
                          className={({ isActive }) => {
                            return ("px-3 py-2 rounded-md text-sm font-medium no-underline" +
                              (isActive ? " bg-gray-900 text-white" : ' text-gray-300 hover:  hover:text-white'))
                          }
                          }
            ...
            <Disclosure.Panel className="sm:hidden">
              <div className="space-y-1 px-2 pt-2 pb-3">
                ...
                {loggedIn ?
                  ...
                  <NavLink
                    to={'/logout'}
                    className="block px-3 py-2 rounded-md text-base font-medium no-underline bg-gray-900 text-white"
                    onClick={() => {
                      console.log('klik')
                      setLoggedIn(false)
                      localStorage.clear()
